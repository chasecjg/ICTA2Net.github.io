...
if __name__ == '__main__':
    fpn_in = [640, 640, 640] #dinov2 backbone
    fpn_out = [256, 512, 1024]
    stride = [1,1,1]
    model = Neck(fpn_in, fpn_out, stride)
    # vis = [torch.randn(2,768, 16,16) for _ in range(3)] 
    vis = [torch.randn(2, 640, 7, 7) for _ in range(3)]
